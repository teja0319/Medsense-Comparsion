    ...
    <div className="space-y-8 animate-pulse">
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <Skeleton className="h-8 w-64 bg-slate-150" />
      ...
      {[1, 2, 3].map((i) => (
        <div key={i} className="rounded-lg border p-4 bg-card space-y-4">
          <div className="flex justify-between items-start">
            <div className="space-y-2 flex-1">
              <Skeleton className="h-6 w-40 bg-slate-150" />
              <div className="space-y-1">
                <Skeleton className="h-4 w-32 bg-slate-100" />
                <Skeleton className="h-4 w-36 bg-slate-100" />
              </div>
            </div>
            <Skeleton className="h-6 w-6 bg-slate-100 rounded" />
          </div>
        </div>
      ))}
    </div>
